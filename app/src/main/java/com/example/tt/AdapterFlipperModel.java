...
public class AdapterFlipperModel {    String name, state; //this is only string, not an array.. if you are using array adapter in adapterviewflipper, you have to use String[] to make it array.
