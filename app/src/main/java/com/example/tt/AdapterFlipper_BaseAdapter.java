...
public abstract class AdapterFlipper_BaseAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        view = inflater.inflate(R.layout.activity_homeadapterflipper, null); //we setted the layout of the flipper. which is the homeadapterflipper file just created by us!
